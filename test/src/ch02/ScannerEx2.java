...
public class ScannerEx2 {
	...
	public static void main(String[] args) {
		...
		String name = scan.next();//문자를 입력받은 next
		System.out.print("나이를 입력하세요 : ");
		short age = scan.nextShort(); //정수인 short타입으로 입력받게하는 nextShort()
		...
		System.out.println("당신의 현금은 " + money + "입니다.");
		System.out.println("당신의 출퇴근거리는 " + distance + "입니다.");
		System.out.println("당신의 키는 " + height + "입니다.");
		System.out.println("당신의 몸무게는 " + weight + "입니다.");

		scan.close();//스캔객체를 종료(메모리상에서 데이터를 삭제)
	}
